	...
	async execute(interaction) {
        try {
            ...
            const message = new EmbedBuilder()
                .setColor('#0099ff')
                .setAuthor({ name: 'Couteau Suisse', iconURL: 'https://srv.latostadora.com/designall.dll/couteau-suisse---dessin-drole-sketchy--i:141385141697014138520;d:1416970;w:520;b:FFFFFF;m:1.jpg', url: 'z'})
